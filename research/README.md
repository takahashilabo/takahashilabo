...
- 勝野翔, VR流鏑馬トレーニングアプリケーションの開発（[動画](https://youtu.be/hDKuvOIQ-nw)）
- 白澤俊斗, LightGBM を用いた万馬券的中のための競馬予想モデルの開発と評価
- 田崎晴音, 歩行者のための後方接近物体リアルタイム検出方式の提案と評価（[動画](https://youtube.com/shorts/u7jHI2LGyuk)）
- 川﨑梨央, 服装履歴を活用したコーディネート提案システムの開発
- 光野達哉, 手指の骨格認識機能を用いた後だしじゃんけんアプリの開発（[動画](https://youtu.be/OuOTeu0EpiI)）
- 根本結, ブラウザ拡張機能を用いた個人時間割作成のための意思決定支援ツールの開発
- 松井美月, MediaPipe を活用したまばたき視線解析による集中度可視化システムの開発
- 吉田清哉, ROS2 と Gazebo を用いた転倒防止ロボット歩行車のシミュレーション環境の構築（[動画](https://youtu.be/tXGPEuwHPNw)）
